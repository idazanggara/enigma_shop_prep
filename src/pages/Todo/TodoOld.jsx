...
class Todo extends Component {
  ...
  // ini kita tempel di inputan
  handleChangeTask = (event) => {
    // console.log("🚀 ~ Todo ~ event:", event)
    // console.log("🚀 ~ Todo ~ value:", event.target.value)
    this.setState({
      form: {
  ...
  handleSubmit = (event) => {
    ...
    // lanjut untu list
    // this.state.todos.push(this.state.form) // ini enggak bisa ya
    const todos = this.state.todos

    // tambah id di state form
    // const todo = {
    //   ...this.state.form,
...
class Todo extends Component {
  render() {
    return (
      <div className="container-fluid pt-4 px-4">
        <h2>Todo</h2>
        <form className="shadow-sm p-4 rounded-2">
          <h3>Form Todo</h3>
          <div className="mb-3">
            <label htmlFor="task" className="form-label">Tugas</label>
            <input type="email" className="form-control" id="task" placeholder="Tugas yg berat dan kita kesana dengan seorang anak" />
          </div>
          <div className="mb-3">
            <label htmlFor="description" className="form-label">Deskripsi</label>
          ...
          <div className="form-check">
            <input className="form-check-input" type="checkbox" value="" id="status" />
            <label className="form-check-label" htmlFor="status">
              Selesai
            </label>
          </div>
